...
Author: Ganjina Oripova
 ...
 - If the mouse is not pressed -> player just stays on its position 
 without doing anything
 - When the game starts enemies automatically start shooting,  
 while coming down to the direction of the player 
 - When the player shoots the enemy -> enemy automatically 
 disappears but still the bullets come down 
 - Player has five lives 
 - When the player gets hit by bullet -> minus one live
 - When the player gets hit by enemy -> game over
